...
public interface ITestDevice {
    ...
    /**
     * A simple struct class to store information about a single partition
     */
    public static class PartitionInfo {
    	public static Map<String, List<PartitionInfo>> deviceMap = new HashMap<String, List<PartitionInfo>>();
    	static {
    		List<PartitionInfo> trout = new ArrayList<ITestDevice.PartitionInfo>();
    		trout.add(new PartitionInfo("yaffs2", "00040000", "00020000", "misc", "/dev/mtd/mtd0ro", null));
    		trout.add(new PartitionInfo("yaffs2", "00500000", "00020000", "recovery", "/dev/mtd/mtd1ro", null));
    		trout.add(new PartitionInfo("yaffs2", "00280000", "00020000", "boot", "/dev/mtd/mtd2ro", null));
    		trout.add(new PartitionInfo("yaffs2", "05a00000", "00020000", "system", "/dev/mtd/mtd3ro", "/system"));
    		trout.add(new PartitionInfo("yaffs2", "00200000", "00020000", "cache", "/dev/mtd/mtd4ro", "/cache"));
    		trout.add(new PartitionInfo("yaffs2", "075c0000", "00020000", "userdata", "/dev/mtd/mtd5ro", "/data"));
    		deviceMap.put("trout", trout);

    		List<PartitionInfo> grouper = new ArrayList<ITestDevice.PartitionInfo>();
    		grouper.add(new PartitionInfo("ext4", "", "", "misc", "/dev/block/mmcblk0p5", null));
    		grouper.add(new PartitionInfo("ext4", "", "", "recovery", "/dev/block/mmcblk0p1", null));
    		grouper.add(new PartitionInfo("ext4", "", "", "boot", "/dev/block/mmcblk0p2", null));
    		grouper.add(new PartitionInfo("ext4", "", "", "system", "/dev/block/mmcblk0p3", "/system"));
    		grouper.add(new PartitionInfo("ext4", "", "", "cache", "/dev/block/mmcblk0p4", "/cache"));
    		grouper.add(new PartitionInfo("ext4", "", "", "bootloader", "/dev/block/mmcblk0p6", null));
    		grouper.add(new PartitionInfo("ext4", "", "", "PER", "/dev/block/mmcblk0p7", null));
    		grouper.add(new PartitionInfo("ext4", "", "", "PDA", "/dev/block/mmcblk0p8", null));
    		grouper.add(new PartitionInfo("ext4", "", "", "userdata", "/dev/block/mmcblk0p9", "/data"));
    		...
    		i9100.add(new PartitionInfo("ext4", "", "", "EFS", "/dev/block/mmcblk0p1", "/efs"));
    		i9100.add(new PartitionInfo("ext4", "", "", "SBL1", "/dev/block/mmcblk0p2", null));
    		i9100.add(new PartitionInfo("ext4", "", "", "SBL2", "/dev/block/mmcblk0p3", null));
    		i9100.add(new PartitionInfo("j4fs", "", "", "PARAM", "/dev/block/mmcblk0p4", null));
       		i9100.add(new PartitionInfo("ext4", "", "", "KERNEL", "/dev/block/mmcblk0p5", null));
       	 	i9100.add(new PartitionInfo("ext4", "", "", "RECOVERY", "/dev/block/mmcblk0p6", null));
    		i9100.add(new PartitionInfo("ext4", "", "", "CACHE", "/dev/block/mmcblk0p7", "/cache"));
    		i9100.add(new PartitionInfo("ext4", "", "", "MODEM", "/dev/block/mmcblk0p8", null));
    		i9100.add(new PartitionInfo("ext4", "", "", "FACTORYFS", "/dev/block/mmcblk0p9", "/system"));
    		i9100.add(new PartitionInfo("ext4", "", "", "DATAFS", "/dev/block/mmcblk0p10", "/data"));
    		i9100.add(new PartitionInfo("ext4", "", "", "UMS", "/dev/block/mmcblk0p11", "/sdcard"));
    		i9100.add(new PartitionInfo("ext4", "", "", "PRE", "/dev/block/mmcblk0p12", "/preload"));
    		deviceMap.put("SMDK4210", i9100);
    	}
    	
        public String type;
        public String start;
        public String erasesize;
        public String name;
         ...
         * Convenience constructor to set all members
         */
        public PartitionInfo(String type, String start, String erasesize, String name, String deviceName, String mountPoint) {
            this.type = type;
            this.start = start;
        ...
        public static String getDeviceNameForMountPoint(String mountPoint) {
        	if ("/system".equals(mountPoint)) {
        		return "system";
        	} else if ("/data".equals(mountPoint)) {
        		return "userdata";
        	} else if ("/cache".equals(mountPoint)) {
        		return "cache";
	    	}
        	return null;
        }

        public static String getMountPointForDeviceName(String deviceName) {
        	if ("system".equals(deviceName)) {
        		return "/system";
        	} else if ("userdata".equals(deviceName)) {
        		return "/data";
        	} else if ("cache".equals(deviceName)) {
        		return "/cache";
	    	}
        	return null;
        }
        ...
        @Override
        public String toString() {
            return String.format("%s %s %s %s %s %s", this.type, this.start, this.erasesize, this.name, this.deviceName, this.mountPoint);
        }
    }
