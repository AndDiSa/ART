...
package de.anddisa.remotebackup.ui;
...
import de.anddisa.remotebackup.AdbWrapper;
...
//        AndroidDebugBridge.addClientChangeListener(this);
        ...
        adbWrapper = new AdbWrapper(ddmsParentLocation);
    ...
    public void selectionChanged(IDevice selectedDevice, Client selectedClient) {
        ...
        if (mCurrentClient != selectedClient) {
        	adbWrapper.selectDevice(selectedDevice.getSerialNumber());
